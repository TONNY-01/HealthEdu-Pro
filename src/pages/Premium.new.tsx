...
const Premium = () => {
  ...
  const verifyPayment = async (reference: string, plan: any) => {
    try {
        ...
        <div className="space-y-6">
          {[
            ...
            },
            {
              ...
              answer: "We accept all major credit/debit cards, bank transfers, and mobile money through Paystack's secure payment gateway."
            },
            {
              question: "Is my payment information secure?",
              answer: "Absolutely. We use Paystack, a PCI DSS Level 1 compliant payment processor. Your payment details are never stored on our servers."
            },
            {
